export default {
  ...
  problems: [
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$28.6 \\text{ in}$' },
        { id: 'c2', text: '$6.6 \\text{ in}$' },
        { id: 'c3', text: '$8.5 \\text{ in}$' },
  ...
  examProblems: [
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: 'The compaction level achieved during construction' },
        { id: 'c2', text: 'The expected moisture conditions and quality of drainage, which reduce the effective structural contribution of granular layers' },
