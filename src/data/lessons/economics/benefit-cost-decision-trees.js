  ...
  examProblems: [
    ...
    },
    {
      ...
      choices: [
        ...
        { id: 'c2', text: 'Either project — both have B/C above 1.0' },
        { id: 'c3', text: 'Project Y — the incremental B/C of moving from X to Y is 1.15' },
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: 'Repair; expected PW = 1,107,000 dollars' },
        { id: 'c2', text: 'Repair; expected PW = 1,000,000 dollars' },
        { id: 'c3', text: 'Replace; expected PW = 1,500,000 dollars — certainty is preferable' },
        { id: 'c4', text: 'Repair; expected PW = 1,470,000 dollars' },
      ],
      correctAnswerId: 'c1',
      difficulty: 'hard',
