  ...
  examProblems: [
    {
      id: 'econ-dti-ex1',
      type: 'computational',
      statement: 'A construction firm buys a dump truck for 120,000 with an estimated salvage value of 20,000 after 10 years. Using straight-line depreciation, what is the annual depreciation deduction?',
      choices: [
        { id: 'c1', text: '10,000 per year' },
        { id: 'c2', text: '12,000 per year' },
        { id: 'c3', text: '2,000 per year' },
        { id: 'c4', text: '14,000 per year' },
      ],
      correctAnswerId: 'c1',
      difficulty: 'easy',
    ...
    },
    {
      id: 'econ-dti-ex2',
      type: 'computational',
      statement: 'A consulting firm has annual revenue of 500,000, operating expenses of 350,000, and a depreciation deduction of 40,000. If the firm\'s tax rate is 25%, what is the annual income tax owed?',
      choices: [
        { id: 'c1', text: '27,500' },
        { id: 'c2', text: '37,500' },
        { id: 'c3', text: '125,000' },
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '9.2% and $(P/F) = 0.644$' },
        { id: 'c2', text: '9.0% and $(P/F) = 0.650$' },
        { id: 'c3', text: '9.2% and $(P/F) = 0.567$' },
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: 'MACRS ignores salvage value and depreciates the full initial cost, while straight-line subtracts salvage value before computing the annual deduction' },
        { id: 'c2', text: 'Straight-line depreciation results in higher total depreciation over the asset\'s life than MACRS' },
        { id: 'c3', text: 'MACRS spreads depreciation evenly across all years, while straight-line front-loads it' },
        { id: 'c4', text: 'MACRS applies only to assets with a useful life of 20 years or more' },
      ],
      correctAnswerId: 'c1',
      difficulty: 'hard',
      eli5: 'This tests whether you understand the structural differences between the two methods. MACRS uses IRS-defined percentages applied to the full purchase price \u2014 salvage value is completely ignored. Straight-line subtracts salvage first and then divides the remainder evenly. Choice B is wrong because total depreciation over the full life is often similar (and MACRS may actually depreciate more since it ignores salvage). Choice C gets it exactly backwards \u2014 MACRS front-loads depreciation into early years, while straight-line is the even method. Choice D is fabricated \u2014 MACRS covers 3-, 5-, 7-, 10-, 15-, and 20-year properties.',
