  ...
  examProblems: [
    {
      id: 'econ-pfa-ex1',
      type: 'computational',
      statement: 'A city is considering purchasing an automated traffic signal controller for 45,000. It will reduce manual labor costs by 8,000 per year for 10 years and has a salvage value of 5,000 at the end of its life. At MARR = 6%, what is the present worth of this investment?',
      choices: [
        { id: 'c1', text: '16,700' },
        { id: 'c2', text: '38,900' },
        { id: 'c3', text: '-2,300' },
    ...
    },
    {
      id: 'econ-pfa-ex2',
      type: 'computational',
      statement: 'A county invests 100,000 in a stormwater management system that generates 15,000 in annual savings for 12 years. There is no salvage value. At MARR = 8%, what is the future worth of this investment at the end of year 12?',
      choices: [
        { id: 'c1', text: '32,800' },
        { id: 'c2', text: '80,000' },
        { id: 'c3', text: '-251,800' },
    ...
    },
    {
      id: 'econ-pfa-ex4',
      type: 'computational',
      statement: 'A contractor is choosing between two air compressors. Compressor A costs 60,000, has annual operating costs of 12,000, a salvage value of 8,000, and a 4-year life. Compressor B costs 90,000, has annual operating costs of 8,000, a salvage value of 12,000, and an 8-year life. At MARR = 10%, which compressor has the lower annual worth of costs?',
      choices: [
        { id: 'c1', text: 'Compressor A, AW = 29,200' },
        { id: 'c2', text: 'Compressor B, AW = 23,800' },
        { id: 'c3', text: 'Compressor A, AW = 27,000' },
        { id: 'c4', text: 'Compressor B, AW = 19,300' },
      ],
      correctAnswerId: 'c2',
      difficulty: 'hard',
