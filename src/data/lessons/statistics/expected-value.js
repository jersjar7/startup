export default {
  ...
  problems: [
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$8.54\\,\\text{kN}$' },
        { id: 'c2', text: '$11.0\\,\\text{kN}$' },
  ...
  examProblems: [
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: 'Standard deviations of independent variables do not add directly; variances must be added first, then the square root taken' },
        { id: 'c2', text: 'The costs are not independent, so neither variances nor standard deviations can be combined' },
