  ...
  examProblems: [
    {
      ...
      steps: [
        ...
        { text: 'Compute each term:', latex: '45{,}000 + 100{,}000 + 56{,}000 = 201{,}000' },
      ],
      handbookPage: 'p. 65',
      handbookFormula: 'E(X) = \\sum_{k=1}^{n} x_k \\cdot P(x_k)',
      videoUrl: null,
      traps: ['Picking the most likely outcome instead of computing the weighted sum', 'Taking the simple average of all costs instead of using probabilities'],
      diagram: null,
    },
    {
      id: 'stat-ev-ex2',
      ...
      steps: [
        ...
        { text: 'Compute $E(X^2)$:', latex: '1(0.15) + 4(0.35) + 9(0.30) + 16(0.15) + 25(0.05) = 7.90' },
        { text: 'Variance:', latex: '\\text{Var}(X) = 7.90 - (2.60)^2 = 7.90 - 6.76 = 1.14' },
        { text: 'Standard deviation:', latex: '\\sigma = \\sqrt{1.14} = 1.07' },
      ],
      handbookPage: 'p. 65',
      handbookFormula: '\\text{Var}(X) = E(X^2) - [E(X)]^2',
      videoUrl: null,
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$12.65\\,\\text{kN/m}$' },
        { id: 'c2', text: '$16.0\\,\\text{kN/m}$' },
        { id: 'c3', text: '$160\\,\\text{kN/m}$' },
        { id: 'c4', text: '$95.0\\,\\text{kN/m}$' },
      ],
      correctAnswerId: 'c1',
      difficulty: 'medium',
      ...
      steps: [
        ...
        { text: 'With $a_1 = 2$, $\\sigma_1 = 6$, $a_2 = 1$, $\\sigma_2 = 4$:', latex: '\\text{Var}(F) = 2^2(6^2) + 1^2(4^2) = 4(36) + 1(16) = 144 + 16 = 160' },
        { text: 'Standard deviation:', latex: '\\sigma_F = \\sqrt{160} = 12.65\\,\\text{kN/m}' },
      ],
      handbookPage: 'p. 65',
      handbookFormula: '\\text{Var}(a_1X_1 + a_2X_2) = a_1^2\\sigma_1^2 + a_2^2\\sigma_2^2',
      videoUrl: null,
      traps: ['Adding scaled standard deviations directly instead of working with variances', 'Forgetting to square the constant multiplier before applying it to the variance'],
      diagram: null,
    },
    {
      id: 'stat-ev-ex4',
      ...
      choices: [
        { id: 'c1', text: 'The costs are not independent, so neither variances nor standard deviations can be combined' },
        { id: 'c2', text: 'Standard deviations of independent variables do not add directly; variances must be added first, then the square root taken' },
        { id: 'c3', text: 'The engineer should have subtracted the standard deviations instead of adding them' },
        { id: 'c4', text: 'The calculation is correct because expected values and standard deviations both add linearly' },
      ],
      correctAnswerId: 'c2',
      difficulty: 'hard',
      ...
      steps: [
        ...
        { text: 'But for standard deviation, the rule is different:', latex: '\\sigma_{\\text{total}} = \\sqrt{\\sigma_1^2 + \\sigma_2^2 + \\sigma_3^2}' },
        { text: 'The correct value:', latex: '\\sigma_{\\text{total}} = \\sqrt{10{,}000^2 + 8{,}000^2 + 5{,}000^2} = \\sqrt{189 \\times 10^6} \\approx 13{,}748' },
        { text: 'This is much less than the naive sum of 23,000 because diversification reduces overall uncertainty.', latex: null },
      ],
      handbookPage: 'p. 65',
      handbookFormula: '\\text{Var}(X_1 + X_2 + \\cdots) = \\sigma_1^2 + \\sigma_2^2 + \\cdots',
      videoUrl: null,
      traps: ['Assuming standard deviations add linearly like expected values', 'Confusing the rules for E(X) and sigma(X) when combining independent variables'],
      diagram: null,
    },
  ],
};
