  ...
  examProblems: [
    {
      ...
      steps: [
        ...
        { text: 'Apply Rule B.2: licensees shall not sign or seal documents unless the work was prepared under their responsible charge.', latex: null },
        { text: '"Responsible charge" means direct control and personal supervision. A post-completion review, no matter how thorough, does not satisfy this requirement.', latex: null },
        { text: 'The engineer must decline to seal. The proper solution is for the work to be redone under the supervision of a licensed PE, or for the supervising PE to seal it.', latex: null },
      ],
      ...
      videoUrl: null,
      traps: ['Equating a thorough after-the-fact review with responsible charge — the supervision must occur during the work, not after', 'Assuming the firm principal can override sealing requirements through managerial authority'],
      diagram: null,
    },
    {
      id: 'eth-oep-ex2',
      ...
      steps: [
        ...
        { text: 'Apply Rule B.4: licensees shall not reveal facts, data, or information obtained in a professional capacity without prior consent of the client or employer.', latex: null },
        { text: 'Apply Rule B.6: licensees shall disclose all known or potential conflicts of interest that could influence or appear to influence their judgment or quality of service.', latex: null },
        { text: 'The engineer must disclose the prior involvement and the conflict to both Firm B and the county. Recusal is required unless all parties provide informed written consent.', latex: null },
      ],
      ...
      videoUrl: null,
      traps: ['Thinking that different project scopes eliminate the conflict — the issue is the confidential information, not the project boundaries', 'Believing you can simply avoid using prior knowledge — you cannot "unknow" information, and the conflict of interest persists regardless'],
      diagram: null,
    },
    {
      id: 'eth-oep-ex3',
      ...
      steps: [
        ...
        { text: 'Apply Rule C.1: licensees shall not misrepresent or exaggerate their degree of responsibility in prior assignments. Presentations incidental to the solicitation of employment shall not misrepresent pertinent facts.', latex: null },
        { text: 'A proposal to a municipality is a "presentation incidental to the solicitation of employment" — C.1 applies directly.', latex: null },
        { text: 'Claiming "lead design engineer" on a 50 MGD facility when the actual role was designing the chemical feed system as a junior team member is a clear exaggeration of responsibility.', latex: null },
      ],
      ...
      videoUrl: null,
      traps: ['Assuming that having any involvement in a project justifies claiming a leadership role', 'Believing that proposals and marketing materials are exempt from Model Rules — C.1 specifically covers solicitation presentations'],
      diagram: null,
    },
    {
      id: 'eth-oep-ex4',
      ...
      choices: [
        { id: 'c1', text: 'Evaluate the proposal objectively since the engineer has no financial interest in the proposing firm' },
        { id: 'c2', text: 'Vote in favor of the proposal if the firm is genuinely the most qualified' },
        { id: 'c3', text: 'Disclose the personal relationship to the board and recuse from the evaluation and vote on this proposal' },
        { id: 'c4', text: 'Disclose the relationship but continue to participate in the evaluation since recusal is only required for financial conflicts' },
      ],
      correctAnswerId: 'c3',
      difficulty: 'hard',
      ...
      steps: [
        { text: 'Identify the relationship: the engineer has a close personal friendship with the principal of the proposing firm, including regular social contact.', latex: null },
        { text: 'Apply Rule B.8: licensees serving as members of a government body shall not participate in decisions with respect to professional services offered by a concern where there is a financial or personal interest.', latex: null },
        { text: 'A close, ongoing personal friendship constitutes a "personal interest" under B.8, even without any financial connection.', latex: null },
        { text: 'Apply Rule B.6: all known or potential conflicts of interest must be disclosed. The personal relationship must be disclosed to the board.', latex: null },
        { text: 'The engineer must both disclose the relationship and recuse from the evaluation and vote. Objectivity alone does not satisfy B.8 when a personal interest exists.', latex: null },
      ],
      ...
      videoUrl: null,
      traps: ['Reading "conflict of interest" as purely financial — B.8 explicitly includes personal interest', 'Believing that objective evaluation is sufficient to satisfy B.8 — the rule requires recusal, not just good intentions'],
      diagram: null,
    },
  ],
};
