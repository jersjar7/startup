  ...
  examProblems: [
    {
      ...
      choices: [
        { id: 'c1', text: '$16 \\text{ sq units}$' },
        { id: 'c2', text: '$48 \\text{ sq units}$' },
        { id: 'c3', text: '$24 \\text{ sq units}$' },
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$1{,}281 \\text{ m}^2$' },
        { id: 'c2', text: '$1{,}025 \\text{ m}^2$' },
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$126.7 \\text{ m}^2$' },
        { id: 'c2', text: '$190.0 \\text{ m}^2$' },
        { id: 'c3', text: '$200 \\text{ m}^2$' },
      ...
      steps: [
        ...
        { text: 'Substitute:', latex: 'A = \\frac{10}{3}(0 + 20 + 16 + 24 + 0) = \\frac{10}{3}(60)' },
        { text: 'Compute:', latex: 'A = \\frac{10}{3} \\times 60 = 200 \\text{ m}^2' },
      ],
      handbookPage: 'p. 280',
