export default {
  ...
  problems: [
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$106.0 \\text{ ft}$' },
        { id: 'c2', text: '$112.0 \\text{ ft}$' },
        { id: 'c3', text: '$107.5 \\text{ ft}$' },
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$400 \\text{ ft}$' },
        { id: 'c2', text: '$200 \\text{ ft}$' },
        { id: 'c3', text: '$100 \\text{ ft}$' },
        { id: 'c4', text: '$300 \\text{ ft}$' },
      ],
      correctAnswerId: 'c4',
      difficulty: 'hard',
  ...
  examProblems: [
    {
      ...
      choices: [
        { id: 'c1', text: '$152.0 \\text{ ft}$' },
        { id: 'c2', text: '$151.5 \\text{ ft}$' },
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$400 \\text{ ft from PVC, elevation } 338.00 \\text{ ft}$' },
        { id: 'c2', text: '$300 \\text{ ft from PVC, elevation } 337.50 \\text{ ft}$' },
        { id: 'c3', text: '$200 \\text{ ft from PVC, elevation } 338.00 \\text{ ft}$' },
