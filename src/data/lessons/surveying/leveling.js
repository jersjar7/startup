export default {
  ...
  problems: [
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$251.44 \\text{ ft}$' },
        { id: 'c2', text: '$245.30 \\text{ ft}$' },
        { id: 'c3', text: '$254.70 \\text{ ft}$' },
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: 'No \u2014 misclosure (0.03 ft) > allowable (0.01 ft)' },
        { id: 'c2', text: 'Yes \u2014 misclosure (0.03 ft) < allowable (0.10 ft)' },
  ...
  examProblems: [
    {
      ...
      choices: [
        { id: 'c1', text: '$309.45 \\text{ ft}$' },
        { id: 'c2', text: '$317.79 \\text{ ft}$' },
        { id: 'c3', text: '$330.55 \\text{ ft}$' },
        { id: 'c4', text: '$322.21 \\text{ ft}$' },
      ],
      correctAnswerId: 'c4',
      difficulty: 'easy',
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$453.32 \\text{ ft}$' },
        { id: 'c2', text: '$446.68 \\text{ ft}$' },
        { id: 'c3', text: '$450.09 \\text{ ft}$' },
