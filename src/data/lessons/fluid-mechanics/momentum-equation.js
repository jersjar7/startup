export default {
  ...
  problems: [
    {
      ...
      choices: [
        { id: 'c1', text: '$150 \\text{ N}$' },
        { id: 'c2', text: '$2{,}250 \\text{ N}$' },
    ...
    },
    {
      ...
      steps: [
        ...
        { text: 'Resultant:', latex: 'F_R = \\sqrt{F_x^2 + F_y^2} = 15{,}271\\sqrt{2} \\approx 21{,}593 \\text{ N} \\approx 21.6 \\text{ kN}' },
      ],
      handbookPage: 'p. 186',
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$502 \\text{ N}$' },
        { id: 'c2', text: '$2{,}749 \\text{ N}$' },
        { id: 'c3', text: '$2{,}278 \\text{ N}$' },
      ...
      steps: [
        ...
        { text: 'Compute:', latex: 'F = 2{,}749 - 471 = 2{,}278 \\text{ N}' },
      ],
      handbookPage: 'p. 186',
      handbookFormula: '\\Sigma F = \\rho Q(v_2 - v_1)',
      videoUrl: null,
  ...
  examProblems: [
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$0.85\\,\\text{kN}$ (in the flow direction)' },
        { id: 'c2', text: '$17.7\\,\\text{kN}$ (in the flow direction)' },
        { id: 'c3', text: '$12.9\\,\\text{kN}$ (in the flow direction)' },
