export default {
  ...
  problems: [
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$45\\degree$' },
        { id: 'c2', text: '$30\\degree$' },
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$2{,}700 \\text{ psf}$' },
        { id: 'c2', text: '$2{,}400 \\text{ psf}$' },
        { id: 'c3', text: '$1{,}200 \\text{ psf}$' },
  ...
  examProblems: [
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: 'Clay particles are flat and smooth, so there is no frictional resistance' },
        { id: 'c2', text: 'Under undrained loading, excess pore pressure absorbs the stress change so effective stress on the failure plane does not change, making shear strength independent of applied normal stress' },
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$26.6\\degree$' },
        { id: 'c2', text: '$45\\degree$' },
        { id: 'c3', text: '$30\\degree$' },
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: 'The specimens consolidated under the higher pressure before shearing, so both reached the same strength' },
        ...
        { id: 'c4', text: 'In a UU test on saturated clay ($\\phi_u = 0$), the confining pressure generates equal excess pore pressure, so effective stress at failure is the same in both tests' },
      ],
      correctAnswerId: 'c4',
      difficulty: 'hard',
