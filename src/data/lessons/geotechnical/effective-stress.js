  ...
  examProblems: [
    {
      ...
      choices: [
        { id: 'c1', text: 'Effective stress increases by $2q$ because both total stress and pore pressure increase by $q$' },
        ...
        { id: 'c4', text: 'Total stress increases by $q$ at all depths, but pore pressure is unchanged, so effective stress increases by $q$' },
      ],
      correctAnswerId: 'c4',
      difficulty: 'easy',
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$944 \\text{ psf}$' },
        { id: 'c2', text: '$445 \\text{ psf}$' },
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: 'Effective stress decreases because the water table dropped' },
        { id: 'c2', text: 'Effective stress stays the same because sigma and u both decrease equally' },
        { id: 'c3', text: 'Effective stress increases because pore pressure decreases more than total stress decreases' },
