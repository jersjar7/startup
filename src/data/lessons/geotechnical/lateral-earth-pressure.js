export default {
  ...
  problems: [
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$9{,}000 \\text{ lb/ft}$' },
        { id: 'c2', text: '$4{,}500 \\text{ lb/ft}$' },
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$4{,}800 \\text{ lb/ft}$' },
        { id: 'c2', text: '$2{,}880 \\text{ lb/ft}$' },
        { id: 'c3', text: '$3{,}680 \\text{ lb/ft}$' },
  ...
  examProblems: [
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$14{,}670 \\text{ lb/ft}$' },
        { id: 'c2', text: '$7{,}330 \\text{ lb/ft}$' },
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: 'The student used degrees instead of radians in the calculator' },
        { id: 'c2', text: 'The formula was applied correctly; $K_a = 2.5$ is reasonable' },
        { id: 'c3', text: 'The student used $\\tan^2(45\\degree + \\phi/2)$ instead of $\\tan^2(45\\degree - \\phi/2)$, computing $K_p$ instead of $K_a$' },
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$K_a = 0.333,\\; K_0 = 0.577,\\; K_0/K_a = 1.73$' },
        { id: 'c2', text: '$K_a = 0.500,\\; K_0 = 0.333,\\; K_0/K_a = 0.67$' },
        { id: 'c3', text: '$K_a = 0.333,\\; K_0 = 0.333,\\; K_0/K_a = 1.00$' },
        { id: 'c4', text: '$K_a = 0.333,\\; K_0 = 0.500,\\; K_0/K_a = 1.50$' },
      ],
      correctAnswerId: 'c4',
      difficulty: 'hard',
