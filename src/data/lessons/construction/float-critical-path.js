export default {
  ...
  examProblems: [
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: 'One critical path; activities only on Path 2 have 4 days of total float' },
        { id: 'c2', text: 'Two critical paths; activities only on Path 2 have 4 days of total float' },
