  ...
  problems: [
    {
      ...
      choices: [
        { id: 'c1', text: '$1.33 \\text{ mm}$' },
        { id: 'c2', text: '$2.67 \\text{ mm}$' },
        { id: 'c3', text: '$5.33 \\text{ mm}$' },
        { id: 'c4', text: '$42.7 \\text{ mm}$' },
      ],
      correctAnswerId: 'c2',
      difficulty: 'easy',
      eli5: 'Straight table lookup \u2014 simply supported beam, midpoint load, max deflection = PL\u00B3/48EI. The unit trap is the big one: everything in N, mm, and MPa. Choice A (1.33) comes from using PL\u00B3/96EI (doubling the denominator). Choice C (5.33) comes from using PL\u00B3/24EI (halving the denominator). Choice D (42.7) comes from using PL\u00B3/3EI (the cantilever formula instead of simply supported).',
