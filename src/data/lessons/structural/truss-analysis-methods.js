  ...
  "problems": [
    {
      ...
      "correctAnswerId": "c1",
      "difficulty": "medium",
      "eli5": "Only the diagonal can resist the vertical load — the horizontal member has no vertical component. So $\\sum F_y = 0$ gives $F_{AC}\\sin 45^\\circ = 500$, hence $F_{AC} = 500/0.707 = 707$ lb. The 500 lb choice forgets to divide by $\\sin 45^\\circ$ and just reports the load. The 354 lb choice multiplies by $\\sin 45^\\circ$ instead of dividing. The 1,000 lb choice uses $\\sin 45^\\circ = 0.5$, which is the sine of 30 degrees.",
    ...
    },
    {
      ...
      "correctAnswerId": "c1",
      "difficulty": "hard",
      "eli5": "Summing moments about the top joint kills the diagonal and the top chord (they pass through or are arms about that point), leaving only the bottom chord. The reaction acts $4\\text{ m}$ horizontally from the moment center; the bottom chord acts at the $3\\text{ m}$ height. So $30(4) = F_{BC}(3)$, giving $F_{BC} = 120/3 = 40\\text{ kN}$ tension. The 30 kN option reports the reaction itself rather than the chord force. The 22.5 kN option swaps the two arms, using $30(3)/4$ instead of $30(4)/3$. The 120 kN option forgets to divide by the 3 m height.",
