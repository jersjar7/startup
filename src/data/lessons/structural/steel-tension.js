  ...
  examProblems: [
    {
      ...
      choices: [
        { id: 'c1', text: '$2.63 \\text{ in}^2$' },
        { id: 'c2', text: '$2.44 \\text{ in}^2$' },
        { id: 'c3', text: '$3.00 \\text{ in}^2$' },
        { id: 'c4', text: '$2.34 \\text{ in}^2$' },
      ],
      correctAnswerId: 'c4',
      difficulty: 'easy',
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$203 \\text{ kips}$' },
        { id: 'c2', text: '$190 \\text{ kips}$' },
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$A_e$ is the same — $U = 1.0$ for all tension members' },
        { id: 'c2', text: '$A_e$ is larger because the unconnected leg adds extra capacity' },
        { id: 'c3', text: '$A_e$ is smaller because the shear lag factor $U < 1.0$ reduces the effective area for the unconnected leg' },
