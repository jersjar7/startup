  ...
  problems: [
    {
      ...
      choices: [
        { id: 'c1', text: '$860 \\text{ kips}$' },
        { id: 'c2', text: '$1{,}323 \\text{ kips}$' },
        { id: 'c3', text: '$688 \\text{ kips}$' },
  ...
  examProblems: [
    {
      ...
      choices: [
        { id: 'c1', text: '$845 \\text{ kips}$' },
        { id: 'c2', text: '$440 \\text{ kips}$' },
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: 'A material safety factor equivalent to the resistance factor $\\phi$' },
        ...
        { id: 'c4', text: 'Accidental eccentricity — columns never truly carry pure concentric axial load' },
      ],
      correctAnswerId: 'c4',
      difficulty: 'medium',
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$1{,}670 \\text{ kips}$' },
        { id: 'c2', text: '$1{,}065 \\text{ kips}$' },
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: 'Transition zone ($0.002 < \\varepsilon_t < 0.005$), interpolate $\\phi$' },
        { id: 'c2', text: 'Tension-controlled ($\\varepsilon_t \\geq 0.005$), $\\phi = 0.90$' },
        { id: 'c3', text: 'Compression-controlled ($\\varepsilon_t \\leq 0.002$), $\\phi = 0.65$' },
