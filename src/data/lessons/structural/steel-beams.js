  ...
  examProblems: [
    {
      ...
      choices: [
        { id: 'c1', text: '$240 \\text{ kip-ft}$' },
        { id: 'c2', text: '$400 \\text{ kip-ft}$' },
        { id: 'c3', text: '$360 \\text{ kip-ft}$' },
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$291 \\text{ kips}$' },
        { id: 'c2', text: '$174 \\text{ kips}$' },
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: 'The second beam has elastic LTB since $L_b > L_r$' },
        ...
        { id: 'c4', text: 'The first beam reaches $M_p = 600$; the second is reduced below $M_p$ by inelastic LTB' },
      ],
      correctAnswerId: 'c4',
      difficulty: 'hard',
