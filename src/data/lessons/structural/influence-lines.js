export default {
  ...
  problems: [
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$260 \\text{ kip-ft}$' },
        { id: 'c2', text: '$240 \\text{ kip-ft}$' },
        { id: 'c3', text: '$200 \\text{ kip-ft}$' },
  ...
  examProblems: [
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$225 \\text{ kip-ft}$' },
        { id: 'c2', text: '$112.5 \\text{ kip-ft}$' },
        { id: 'c3', text: '$450 \\text{ kip-ft}$' },
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: 'Just to the right of the section' },
        { id: 'c2', text: 'At midspan' },
        { id: 'c3', text: 'Just to the left of the section' },
        { id: 'c4', text: 'At the right support' },
      ],
      correctAnswerId: 'c1',
      difficulty: 'hard',
