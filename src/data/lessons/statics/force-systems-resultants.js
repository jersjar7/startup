export default {
  ...
  examProblems: [
    ...
    },
    {
      ...
      correctAnswerId: 'c2',
      difficulty: 'hard',
      eli5: 'Two forces create moments about the base. Set coordinates: pole base at origin, arm tip at $(3, 0)$, brace attachment at $(0, 2)$. The signal (500 N downward at 3 m horizontal) creates a clockwise moment of $500 \\times 3 = 1{,}500$ N$\\cdot$m. The brace runs from tip $(3, 0)$ toward pole at $(0, 2)$, direction $(-3, 2)$, length $= \\sqrt{9 + 4} = \\sqrt{13}$. Brace force components: $F_x = -1{,}300(3/\\sqrt{13}) = -1{,}082$ N (toward pole), $F_y = 1{,}300(2/\\sqrt{13}) = 721$ N (upward). Moment of brace vertical component about base: $3 \\times 721 = 2{,}163$ N$\\cdot$m counterclockwise. Net moment $= 1{,}500 - 2{,}163 = -663$ N$\\cdot$m. Hmm, that does not match choice B — this problem has geometry that makes the exact answer dependent on the arm height. The key concept: resolve the brace into components, then sum each component\u2019s moment about the base.',
