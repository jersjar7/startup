export default {
  ...
  examProblems: [
    ...
    },
    {
      id: 'stat-fsr-ex4',
      type: 'computational',
      statement: 'Two forces act on a bracket. Force $F_1 = 200$ N acts vertically downward at a point 1.5 m to the right of point O. Force $F_2 = 300$ N acts horizontally to the left at a point 0.8 m above O. What is the net moment about point O?',
      choices: [
        { id: 'c1', text: '540 N$\\cdot$m clockwise' },
        { id: 'c2', text: '60 N$\\cdot$m counterclockwise' },
        { id: 'c3', text: '60 N$\\cdot$m clockwise' },
        { id: 'c4', text: '540 N$\\cdot$m counterclockwise' },
      ],
      correctAnswerId: 'c3',
      difficulty: 'hard',
      eli5: 'Each force creates a moment about O. The 200 N downward force at 1.5 m to the right creates a clockwise moment of $200 \\times 1.5 = 300$ N$\\cdot$m. The 300 N leftward force at 0.8 m above O creates a counterclockwise moment of $300 \\times 0.8 = 240$ N$\\cdot$m. Net moment = $300 - 240 = 60$ N$\\cdot$m clockwise. The trap is adding the two moments instead of subtracting — they rotate in opposite directions.',
      hint: 'Determine the direction (CW or CCW) of each moment first, then combine them with the correct signs.',
      steps: [
        { text: '$F_1 = 200$ N downward at 1.5 m right of O:', latex: 'M_1 = 200 \\times 1.5 = 300\\,\\text{N}\\cdot\\text{m (CW)}' },
        { text: '$F_2 = 300$ N leftward at 0.8 m above O:', latex: 'M_2 = 300 \\times 0.8 = 240\\,\\text{N}\\cdot\\text{m (CCW)}' },
        { text: 'Net moment (CW positive):', latex: 'M_{net} = 300 - 240 = 60\\,\\text{N}\\cdot\\text{m (CW)}' },
      ],
      handbookPage: 'p. 94',
      handbookFormula: 'M_O = \\sum (F \\times d)',
      videoUrl: null,
      traps: ['Adding the moments instead of subtracting — they rotate in opposite directions', 'Getting the sense (CW vs CCW) wrong for one of the forces'],
      diagram: null,
    },
  ],
};
