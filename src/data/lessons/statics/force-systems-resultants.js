export default {
  ...
  examProblems: [
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '1,600 N$\\cdot$m clockwise' },
        { id: 'c2', text: '2,000 N$\\cdot$m clockwise' },
        { id: 'c3', text: '2,400 N$\\cdot$m clockwise' },
        { id: 'c4', text: '800 N$\\cdot$m counterclockwise' },
      ],
      correctAnswerId: 'c2',
      difficulty: 'medium',
      ...
      steps: [
        { text: 'Moment from the 600 N downward force at the free end (4 m from wall):', latex: 'M_1 = 600 \\times 4 = 2{,}400\\,\\text{N}\\cdot\\text{m (CW)}' },
        { text: 'Moment from the 200 N upward force at midpoint (2 m from wall):', latex: 'M_2 = 200 \\times 2 = 400\\,\\text{N}\\cdot\\text{m (CCW)}' },
        { text: 'Net moment (taking CW as positive):', latex: 'M_{net} = 2{,}400 - 400 = 2{,}000\\,\\text{N}\\cdot\\text{m (CW)}' },
      ],
      handbookPage: 'p. 94',
      handbookFormula: 'M_O = \\sum (F \\times d)',
      videoUrl: null,
      traps: ['Only counting the larger force and ignoring the 200 N upward force (gives 2,400 instead of 2,000)', 'Subtracting force magnitudes before multiplying by distance instead of computing each moment separately'],
      diagram: null,
    },
  ],
};
