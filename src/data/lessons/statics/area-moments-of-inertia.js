  ...
  examProblems: [
    ...
    },
    {
      ...
      steps: [
        ...
        { text: 'Moment of inertia about one centroidal axis:', latex: 'I_x = \\frac{\\pi r^4}{4} = \\frac{\\pi (100)^4}{4} = 78.54 \\times 10^6\\,\\text{mm}^4' },
        { text: 'For a circle, $I_x = I_y$ by symmetry. The polar moment is their sum:', latex: 'J = I_x + I_y = 2 \\times 78.54 \\times 10^6 = 157.1 \\times 10^6\\,\\text{mm}^4' },
        { text: 'Equivalently, the direct formula gives the same result:', latex: 'J = \\frac{\\pi d^4}{32} = \\frac{\\pi (200)^4}{32} = 157.1 \\times 10^6\\,\\text{mm}^4' },
      ],
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$71.9 \\times 10^6\\,\\text{mm}^4$' },
        { id: 'c2', text: '$113.3 \\times 10^6\\,\\text{mm}^4$' },
        { id: 'c3', text: '$7.09 \\times 10^6\\,\\text{mm}^4$' },
        { id: 'c4', text: '$6.83 \\times 10^6\\,\\text{mm}^4$' },
      ],
      correctAnswerId: 'c1',
      difficulty: 'hard',
      ...
      steps: [
        ...
        { text: 'Bottom flange (200 $\\times$ 20 mm), centroid at $y = 10$ mm, $d = 90$ mm:', latex: 'I_{bot} = \\frac{200 \\times 20^3}{12} + (200 \\times 20)(90)^2 = 0.133 \\times 10^6 + 32.4 \\times 10^6 = 32.53 \\times 10^6\\,\\text{mm}^4' },
        { text: 'Top flange is symmetric to the bottom flange:', latex: 'I_{top} = I_{bot} = 32.53 \\times 10^6\\,\\text{mm}^4' },
        { text: 'Total:', latex: 'I_x = 6.83 + 32.53 + 32.53 \\approx 71.9 \\times 10^6\\,\\text{mm}^4' },
        { text: 'Note how the flanges\' $Ad^2$ terms dominate — that is why wide flanges far from the centroid make beams stiff.', latex: null },
      ],
      handbookPage: 'pp. 94–95',
      handbookFormula: 'I_x = \\bar{I}_{xc} + Ad^2',
      videoUrl: null,
      traps: ['Forgetting the $Ad^2$ transfer terms for the flanges', 'Using the full 200 mm height in a single $bh^3/12$ as if it were a solid rectangle'],
      diagram: null,
    },
  ],
};
