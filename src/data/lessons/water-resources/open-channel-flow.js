  ...
  examProblems: [
    {
      ...
      choices: [
        { id: 'c1', text: 'The discharge is overestimated by about 49%' },
        { id: 'c2', text: 'The discharge is underestimated by about 33%' },
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$3.2\\,\\text{m}^3/\\text{s}$' },
        { id: 'c2', text: '$7.1\\,\\text{m}^3/\\text{s}$' },
        { id: 'c3', text: '$7.8\\,\\text{m}^3/\\text{s}$' },
      ...
      steps: [
        ...
        { text: 'Compute:', latex: 'Q = 45.45 \\times 9.0 \\times 0.951 \\times 0.02 = 7.8\\,\\text{m}^3/\\text{s}' },
      ],
      handbookPage: 'p. 297',
      handbookFormula: 'Q = \\frac{K}{n} A R_H^{2/3} S^{1/2}',
      videoUrl: null,
    ...
    },
    {
      ...
      steps: [
        ...
        { text: 'Trial at $y = 2.0$ ft:', latex: 'A = 12.0,\\; R_H = \\frac{12.0}{10.0} = 1.200,\\; Q = 3.429 \\times 12.0 \\times 1.129 = 46.5' },
        { text: 'Trial at $y = 2.1$ ft:', latex: 'A = 12.6,\\; R_H = \\frac{12.6}{10.2} = 1.235,\\; Q = 3.429 \\times 12.6 \\times 1.151 = 49.8' },
        { text: 'At $y = 2.1$ ft, $Q \\approx 50$ cfs. Normal depth $\\approx 2.1\\,\\text{ft}$.', latex: null },
      ],
      handbookPage: 'p. 297',
      handbookFormula: 'Q = \\frac{K}{n} A R_H^{2/3} S^{1/2}',
      videoUrl: null,
      ...
      diagram: { component: 'RectangularChannel', props: { b: 6, y: 2.1, unit: 'ft' } },
    },
  ],
};
