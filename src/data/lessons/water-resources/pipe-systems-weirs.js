export default {
  ...
  problems: [
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$10.2 \\text{ ft}^3\\text{/s}$' },
        { id: 'c2', text: '$7.2 \\text{ ft}^3\\text{/s}$' },
        { id: 'c3', text: '$14.4 \\text{ ft}^3\\text{/s}$' },
  ...
  examProblems: [
    {
      ...
      choices: [
        { id: 'c1', text: '$C$ only affects velocity, not discharge, because area is independent of roughness' },
        ...
        { id: 'c4', text: 'Higher $C$ means a smoother pipe interior and greater flow capacity for the same head loss' },
      ],
      correctAnswerId: 'c4',
      difficulty: 'easy',
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: '$17.5\\text{ ft}^3\\text{/s}$' },
        { id: 'c2', text: '$16.5\\text{ ft}^3\\text{/s}$' },
    ...
    },
    {
      ...
      choices: [
        { id: 'c1', text: 'The rectangular weir discharge increases more because it has a wider opening' },
        { id: 'c2', text: 'Both discharges increase by the same factor because weir equations are linear in $H$' },
        { id: 'c3', text: 'The V-notch discharge increases by a factor of $2^{5/2} \\approx 5.66$, while the rectangular increases by $2^{3/2} \\approx 2.83$' },
