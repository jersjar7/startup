export default {
  ...
  traps: [
    ...
    'Failing to reject $H_0$ does NOT mean $H_0$ is true — similarly, "fail to reject" an engineer\'s work doesn\'t mean it\'s correct.',
