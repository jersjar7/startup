...
const PROBLEMS = [
  ...
  },
  {
    ...
    diagram: { component: 'GradientCashFlow', props: { base: 5000, gradient: 1000, n: 8, rate: 10 } },
    lessonId: 'equivalence-interest-factors',
    chapterId: 'economics',
  },
  {
  ...
  },
  {
    ...
    diagram: { component: 'AnnualWorthComparison', props: { costX: 40000, omX: 10000, salvX: 0, nX: 3, labelX: 'Compactor M', costY: 60000, omY: 7000, salvY: 0, nY: 6, labelY: 'Compactor N', rate: 10 } },
    lessonId: 'pw-fw-aw-analysis',
    chapterId: 'economics',
  },
  {
