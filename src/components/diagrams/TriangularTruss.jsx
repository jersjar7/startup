...
export function TriangularTruss({ span = 6, height = 4, load = 10 }) {
  ...
  return (
    <svg viewBox="0 0 360 240" xmlns="http://www.w3.org/2000/svg"
      ...
      <line x1={ax} y1={ay} x2={cxPos} y2={cy}
        stroke="var(--charcoal)" strokeWidth={2.5} />
      <line x1={bx} y1={by} x2={cxPos} y2={cy}
        stroke="var(--charcoal)" strokeWidth={2.5} />
      ...
      <Label x={cxPos} y={cy - 68} color="var(--charcoal)" bold>
        {load} kN
      </Label>

      {/* Dimension: span */}
      <line x1={ax} y1={ay + 44} x2={bx} y2={ay + 44}
        stroke="var(--gray-400)" strokeWidth={1} />
      <line x1={ax} y1={ay + 38} x2={ax} y2={ay + 50}
        stroke="var(--gray-400)" strokeWidth={1} />
      <line x1={bx} y1={ay + 38} x2={bx} y2={ay + 50}
        stroke="var(--gray-400)" strokeWidth={1} />
      <Label x={(ax + bx) / 2} y={ay + 58} fontSize={11}>
        {span} m
      </Label>

      {/* Dimension: height */}
      <line x1={bx + 30} y1={ay} x2={bx + 30} y2={cy}
        stroke="var(--gray-400)" strokeWidth={1} />
      <line x1={bx + 24} y1={ay} x2={bx + 36} y2={ay}
        stroke="var(--gray-400)" strokeWidth={1} />
      <line x1={bx + 24} y1={cy} x2={bx + 36} y2={cy}
        stroke="var(--gray-400)" strokeWidth={1} />
      <Label x={bx + 46} y={(ay + cy) / 2} fontSize={11}>
        {height} m
      </Label>
