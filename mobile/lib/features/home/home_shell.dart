...
class _HomeShellState extends State<HomeShell> {
  ...
  static const _titles = ['Study', 'Review', 'Profile'];
      ...
      body: SafeArea(
        child: Center(
          child: Column(
            ...
            children: [
              Text(_titles[_index], style: AppTheme.heading(size: 26)),
              const SizedBox(height: 8),
              Text('Coming together next', style: TextStyle(color: AppColors.ink3)),
              if (_index == 2) ...[
